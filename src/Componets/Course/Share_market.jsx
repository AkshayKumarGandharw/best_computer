      ...
      const a = useContext(noteContext)
       return (
        ...
        <Container fluid className='colorBackground'>
          <Row>
            <Col lg={8}>
              <h2 className='px-3 py-2'>{a.titleSm}</h2>
              ...
              <div className="experince-teachers">
                ...
                <div className="rectangle-box">
                  <div className="img-circle">
                    <img src={a.titleImageSm} alt="" className='' />
                  </div>
                  <div className="profile-teacher">
            ...
            <Col lg={4}>
              <div className="box-3">
                ...
                <div className="img">
                  <img src={a.titleImageSm} alt="" className='img-fluid width-less-100' />
                </div>
                <div className="course-detail">
                  <div className="row course-row px-3 pe-3">
                    <div className="col d-flex py-3  ">
                      ...
                      <div className="ms-2 "><h3 className='h3'><b>{a.titleSm} </b></h3></div>
                    </div>
                  </div>
                  <div className="row course-row px-3 pe-3 ">
